...
export default function IntroStatement({ data }: any) {
  if (!data) return null;
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24 items-start">
          <div className="col-span-1 md:col-span-8 relative">
            <div className="relative z-10">
              ...
              <a
                href={data.przycisk?.linkPrzycisku}
                className="group inline-flex items-center gap-3 border-b border-white/10 pb-1 hover:border-[#D4A373] transition-all duration-300 mt-8"
              >
                <span className="text-sm font-bold uppercase tracking-widest text-stone-500 group-hover:text-[#D4A373] transition-colors">
                  {data.przycisk?.buttonText}
                </span>
                <LiaArrowRightSolid
                  size={16}
                  className="text-stone-500 group-hover:text-[#D4A373] group-hover:translate-x-2 transition-all"
                />
              </a>
            </div>
          </div>
              ...
              <div className="flex flex-col items-center justify-center gap-2 group cursor-help">
                <div className="w-10 h-10 rounded-xl bg-[#050505] border border-white/10 flex items-center justify-center text-[#D4A373] group-hover:scale-110 transition-transform">
                  ...
                  >
                    ...
                    <path d="M12 20a4 4 0 0 0 0-8 4 4 0 0 0 0 8z"></path>
                    <path d="M1 12s4-8 11-8 11 8-8 11 8z"></path>
                  </svg>
                </div>
