      ...
      <main className="bg-[#FAF9F6] text-[#171717] font-sans min-h-screen">
        ...
        <section className="h-[50vh] md:h-[60vh] w-full bg-[#0a0a0a] text-white flex flex-col justify-center items-center relative">
          ...
          <div className="relative z-10 text-center px-6">
             <p className="text-[#D4A373] font-bold uppercase tracking-[0.3em] text-xs mb-6">Wynajem • Kostrzyca</p>
        ...
        <section className="max-w-[1600px] mx-auto px-6 py-20 md:py-32">
            <div className="max-w-2xl mx-auto text-center mb-20">
                <h2 className="text-3xl md:text-4xl font-serif mb-6 text-[#171717]">Wybierz Swój Świat Na Chwilę</h2>
                <p className="text-stone-500 text-lg font-light">
                    Każdy domek został zaprojektowany z myślą o różnych potrzebach, zachowując ten sam komfortowy standard.
                </p>
            </div>
